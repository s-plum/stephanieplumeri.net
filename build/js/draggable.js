!(function(moduleName, definition) {
  ...
  function startDragging(event, element, container) {
    currentElement && sendToBack(currentElement);
    currentElement = bringToFront(element);


    var initialPosition = getInitialPosition(currentElement, container);
  ...
  function getInitialPosition(element, container) {
    var boundingClientRect = element.getBoundingClientRect();
    var style = window.getComputedStyle(element);
    var outerBounds = container.getBoundingClientRect();
    return {
      top: boundingClientRect.top - outerBounds.top - parseInt(style['margin-top']),
      left: boundingClientRect.left - outerBounds.left - parseInt(style['margin-left'])
    };
  }
